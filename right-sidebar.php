		...
		<div class="container">
			...
			<form id="download_catalog" action="">
				...
				<select class="form-control" id="country_name" name="country_name">
                    ...
                    <option value="1345">Cayman Islands 5</option>
                    ...
                    <option value="721">Sint Maarten </option>
                    ...
                    <option value="7370">Turkmenistan 0</option>
                ...
                <div class="mobile">
                    <input class="number-prefix" type="text" id="selected_country" readonly>
                    <input class="number-postfix" type="number" id="mobile" name="mobile" placeholder="Write Your mobile..">
                </div>

				<textarea id="message" class="form-control" name="message" placeholder="Write your message.." style="height:70px"></textarea>
    ...
    $("#download_catalog").submit(function(event) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                //console.error("Error:" ror);
              //  console.log("AJAX Error: " ror);
...
<script>
    $(document).ready(function() {
        // Get references to the select element and the read-only field
        const $countryName = $("#country_name");
        const $countryCode = $("#selected_country");

        // Add a change event listener to the select element
        $countryName.on("change", function() {
            // Get the selected option
            const selectedCountry = $countryName.find("option:selected");

            // Set the value of the read-only field to the selected option's value
            $countryCode.val(selectedCountry.val());
        });
    });
</script>